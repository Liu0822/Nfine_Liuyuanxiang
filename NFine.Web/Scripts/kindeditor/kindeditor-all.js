...
KindEditor.lang({
    ...
    'multiimage.uploadDesc': '<span style="color:#ff0000;"><i class="fa fa-lock"></i>&nbsp;&nbsp;允许用户同时上传<%=uploadLimit%>张图片，单张图片容量不超过<%=sizeLimit%></span>',
	...
	self.plugin.flash = {
		edit : function() {
			var html = [
				...
				'<span class="ke-button-common ke-button-outer">',
				//'<input type="button" class="ke-button-common ke-button" name="viewServer" value="' + lang.viewServer + '" />',   //去掉flash 零时空间按钮
				'</span>',
				'</div>',
				//width
				'<div class="ke-dialog-row">',
...
KindEditor.plugin('image', function(K) {
	...
	self.plugin.imageDialog = function(options) {
		...
		var html = [
			'<div style="padding:20px;">',
			//tabs       
            //'<span style="color:#ff0000;"><i class="fa fa-lock"></i>&nbsp;&nbsp;请选择本地上传功能</span>',
            '<br />', '<br />',
            '<div class="tabs"></div>',
			//remote image - 网络图片开始拼接   
			...
			'<span class="ke-button-common ke-button-outer">',
			//'<input type="button" class="ke-button-common ke-button" name="viewServer" value="' + lang.viewServer + '" />',    // 去掉上传 图片的零时空间
			'</span>',
			'</div>',
			//size
			//'<div class="ke-dialog-row">',
...
KindEditor.plugin('insertfile', function(K) {
	...
	self.plugin.fileDialog = function(options) {
		...
		var html = [
			...
			'<input type="button" class="ke-upload-button" value="' + lang.upload + '" /> &nbsp;',
			'<span class="ke-button-common ke-button-outer">',
			//'<input type="button" class="ke-button-common ke-button" name="viewServer" value="' + lang.viewServer + '" />',   //去掉上传文件 零时空间按钮
			'</span>',
			'</div>',
			//title
			'<div class="ke-dialog-row">',
			'<label for="keTitle" style="width:60px;">' + lang.title + '</label>',
			'<input type="text" id="keTitle" class="ke-input-text" name="title" value="" style="width:200px; height:100px;" /></div>',
			'</div>',
			//form end
			'</form>',
			'</div>'
