        ...
        return this.each(function () {
            ...
            endReq = function () {
                ...
                if (ts.p.unwritten) {
                    ...
                    //}
                 if ($("#" + ts.p.id).find('tbody tr').length == 1) {
                     $("#" + ts.p.id).parents('.ui-jqgrid-bdiv').append('<div class="unwritten" style="padding:4px; margin-top:350px; height:150px;  background-image:url(/Content/img/nodata.jpg); background-repeat:no-repeat; background-position:center;"></div>')
                    }
                }
            },
