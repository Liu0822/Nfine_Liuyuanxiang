...
namespace NFine.Web.Controllers
{
    ...
    {
        private OrderApp odapp = new OrderApp();
        private MyRecordApp MyRecordApp = new MyRecordApp();
        /// <summary>
        /// 获取L_MyRecord表数据下拉  返回Json
        /// </summary>
        /// <param name="F_Id">主键</param>
        /// <returns></returns>
        [HttpPost]
        public JsonResult GetProjInfoData(string F_Id)
        {
            //查询L_MyRecord表的Id和titlte
            var DataSource = MyRecordApp.GetCustomByUserId(false).Select(t => new { id = t.F_Id, value = t.L_Title});
            var jsonData = new
            {
        ...
        /// <summary>
        /// 查询Sendmessages表数据  通过下拉带出指定字段
        /// </summary>
        /// <param name="F_Id"></param>
        /// <returns></returns>
        //public JsonResult GetSendmessagesData(string F_Id)
        //{
